public class PlayerBlue implements Player {
    ...
    public PlayerBlue(boolean isAgent) {
    ...
    private int get_next_move_human(Game game) {
        ...
        while (move == -1) {
            ...
            System.out.println("(3) Release a Grey Agent");
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.print("\033[0;37m"); // change color to grey
                    System.out.println("Blue releases a Grey Agent");
                    move = 3;
                    break;
                case 9:
